export class PushNotificationService {
  ...
  sendEventNotification(eventTitle: string, eventDate: string, notificationType: string): Promise<boolean> {
    const typeMessages = {
      same_day: "Today!",
      day_before: "Tomorrow!",
    ...
    const message = typeMessages[notificationType as keyof typeof typeMessages] || "Soon!"
