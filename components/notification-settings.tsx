          ...
          <CardContent className="space-y-6">
            ...
            <div className="space-y-3">
              ...
              {preferences.notify_week_before && (
                <div className="ml-6">
                  <Label htmlFor="week-before-time" className="text-sm text-muted-foreground">
                    Time
                  </Label>
                  <Input
                    id="week-before-time"
            ...
            <div className="space-y-3">
              ...
              {preferences.notify_day_before && (
                <div className="ml-6">
                  <Label htmlFor="day-before-time" className="text-sm text-muted-foreground">
                    Time
                  </Label>
                  <Input
                    id="day-before-time"
            ...
            <div className="space-y-3">
              ...
              {preferences.notify_same_day && (
                <div className="ml-6">
                  <Label htmlFor="same-day-time" className="text-sm text-muted-foreground">
                    Time
                  </Label>
                  <Input
                    id="same-day-time"
